...
RENDER_STYLE = (
    ...
    "- PERSPECTIVE (founder): the world's objective STATE may be stated plainly and "
    "need not be in second person — 'the gas burns low,' 'fog presses the glass,' "
    "'the ledgers are gone from the shelf.' BUT the moment a description involves the "
    "PLAYER — their presence, what they perceive or notice, their viewpoint, or how "
    "others relate to them — lead in SECOND PERSON: a detail they'd spot is something "
    "'you notice' / 'your eye snags on' / 'you catch' (not a free-floating fact — "
    "'low on the jamb, where a careless eye would skip it, you notice a single black "
    "fibre,' NOT 'a fibre clings to the jamb'); an NPC's regard is 'she keeps her eyes "
    "on you,' 'the room's attention turns to you.' World-state: plain is fine. "
    "Your presence / perception / relationships: second person, first.\n"
